...
Plans:
- [ ] 13-01-PLAN.md — P1 코드/설정 rename: 4 manifest + 92+ import + Dockerfile/docker-compose/ci.yml/provision-valkey.sh/seed/fixture/docs (D-01/D-03/D-05/D-06/D-07 exceptions)
- [ ] 13-02-PLAN.md — P2 사용자 노출 카피: UI 로고/footer/admin + email subject + SMS body + legal MD (D-07 @heygrabit.com)
